      ...
      {viewStudent && (
        <div className="modal">
          <div className="modal-content">
            ...
            <p>
              <strong>Date of Birth:</strong> {viewStudent.dateOfBirth}
            </p>
            <p>
            ...
            <p>
              <strong>Parent Name:</strong> {viewStudent.parentName}
            </p>
            <p>
              <strong>Contact Number:</strong> {viewStudent.contactNumber}
            </p>
            <p>
              <strong>Email ID:</strong> {viewStudent.emailId}
            </p>
            <p>
              <strong>Active:</strong> {viewStudent.isActive ? "Yes" : "No"}
            </p>
            <p>
              <strong>Admission Date:</strong> {viewStudent.admissionDate}
            </p>
            <form>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            >
              ...
              <label>
                Class:
                <input name="class" defaultValue={editStudent.class} required />
              </label>
              <label>
                Section:
                <input
              ...
              <label>
                ...
                <input
                  name="parentName"
                  defaultValue={editStudent.parentName}
                  required
                />
              </label>
              <label>
